...
const CATEGORIES = [
...

  {
    ...
    words_es: ['Fútbol', 'Basketball', 'Tenis', 'Natación', 'Boxeo', 'Surf', 'Karate', 'Voleibol', 'Golf', 'Béisbol', 'Hockey', 'Rugby', 'Ciclismo', 'Esquí', 'Skateboard', 'Ping Pong', 'Bádminton', 'Lucha', 'Judo', 'Esgrima', 'Polo', 'Escalada', 'Remo', 'Arquería', 'Gimnasia', 'Atletismo', 'Snowboard', 'Patinaje', 'Triatlón', 'Waterpolo', 'Handball', 'Cricket', 'Salto Alto', 'Lanzamiento de Disco', 'Meter un gol', 'Encestar pelota', 'Nadar estilo mariposa', 'Hacer un home run', 'Levantamiento de pesas', 'Luchar como ninja'],
